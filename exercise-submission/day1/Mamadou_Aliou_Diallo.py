...
list_of_numbers=[2,7,6,8,9]
    
    summ=0
    
    for p in range(len(list_of_numbers)):
        summ=list_of_numbers[p]+summ
    
    mean=summ/len(list_of_numbers)
...
def concatenate_strings(first_name, last_name):
    ...
    first_name="The teacher is good "
    last_name="at python"
